...
const Search = (props) => {
    ...
    return(
        <div className="container">
            {/* <Main /> */}
            {
                items.filter( a => a.name.toLowerCase().replace(/[^a-zA-Z ]/g, "").includes(props.search) || a.category.toLowerCase().replace(/[^a-zA-Z ]/g, "").includes(props.search) || a.brand.toLowerCase().replace(/[^a-zA-Z ]/g, "").includes(props.search)).map(a=>
                    true? 
